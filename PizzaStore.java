 ...
 */
 ...
 // Rest of the functions definition go in here
    ...
    public static void updateProfile(PizzaStore esql, String User) {
       try {
          ...
          if (read_input == 1 ) {
             ...
             if (input_password.equals(user_data.get(0).get(1))) { // due to how the data base gets varchar
    ...
    try {
       ...
       // Prompt user to enter items and quantities
       while (true) {
       ...
       // Insert order into FoodOrder table with manually generated orderID
    ...
    public static void updateMenu(PizzaStore esql, String User) {
       try {
          ...
          if(esql.executeQuery(u) == 1) {
             ...
             throw new Exception("Only Manager can update the Menu.");
          }
    ...
    public static void updateUser(PizzaStore esql, String User) {
       try {
          ...
          if(esql.executeQuery(u) == 1) { // means that the authorized user was found holding the manager role
             System.out.println("Hello Manager, please select the following options");
             ...
             if (read_input == 1) {
                ...
                if (rowCount == 1) { // the login exists in the data base
                   ...
                   throw new Exception(find_user+" does not exist");
                }
                ...
                if (rowCount == 1) {
                   ...
                   if (role_update.equals("manager") || role_update.equals("driver") || role_update.equals("customer")) {
                      String update_role = "UPDATE Users SET role = '" + role_update + "' WHERE login = '"+find_user+ "';";
                      esql.executeUpdate(update_role);
                ...
                throw new Exception("Invalid input option. Going back to main menu");   
             }
 
          }
          else {
             throw new Exception("Only manager role can update a User. Access Denied");
